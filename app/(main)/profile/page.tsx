  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-center p-4">
      <div className="text-center md:text-left md:mr-8">
        <h1 className="text-2xl font-bold mb-2">Your unique code is:</h1>
        <p className="text-9xl font-semibold mb-4">{userCode}</p>{" "}
        <div className="text-sm md:text-base">
          <p>Download the Climax app and enter your code on your phone!</p>
          <p className="mb-3">
            Then, join a room and your watch will automatically start tracking
            your heart rate!
          </p>
          <Link href="/roommenu">
            <Button size="lg">Rooms</Button>
          </Link>
        </div>
      </div>
